<template>
  <InfoBox :typeCol="typeCol">
    <h3 slot="title">Evolution</h3>
    <div slot="content" class="abilities-box d-flex flex-center">
      <div class="evolution-pokemon d-flex flex-center" v-for="(pokemon,i) in evolutionPokemons" :key="i">
        <div class="text-center">
            <img class="w-60 mx-10" :src="fetchImg(pokemon.id)" :alt="pokemon.name" />
...
export default {
  ...
  methods: {
    formatEvolution() {
      ...
      console.log(this.evolutionPokemons, "EP");
    },
  ...
  mounted() {
    console.log(this.evolution, "evp");
